...
public class PlayerStatus : MonoBehaviour
{
    ...
    private List<HpColumn> columns = new List<HpColumn>();
    ...
    private void Setup()
    {
        ...
        {
            columns.Add(new HpColumn(i * space - width * 0.5f, height, k, m, drag));
        }
    }
    ...
    public class HpColumn
    {
        public float xPos, height, targetHeight, k, m, velocity, drag;

        public HpColumn(float xPos, float targetHeight, float k, float m, float drag)
        {
            this.xPos = xPos;
